...
var translations = {
  ...
  pauseOptions: {
    ja: ["演奏をつづける", "はじめからやりなおす", "「曲をえらぶ」にもどる"],
    en: ["Continue", "Retry", "Back to Select Song"],
    cn: ["继续演奏", "从头开始", "返回「选择乐曲」"],
    tw: ["繼續演奏", "從頭開始", "返回「選擇樂曲」"],
    ko: ["연주 계속하기", "처음부터 다시", "「곡 선택」으로"],
  },
  results: {
    ja: "成績発表",
    en: "Score",
  ...
  about: {
    bugReporting: {
      ...
      en: ["This simulator is still in development."],
      cn: [
        "这款模拟器仍处于开发中，",
  ...
  account: {
    ...
    currentNewRepeat: {
      ...
      en: ["Current Password", "New Password", "Repeat New Password"],
      tw: ["目前密碼", "新密碼", "重複新密碼"],
      ko: ["현재 비밀번호", "새 비밀번호", "새 비밀번호 재입력"],
    },
    deleteAccount: {
      ja: "アカウント削除",
      en: "Delete Account",
  ...
  customSongs: {
    ...
    description: {
      ...
      tw: ["請選擇包含太鼓譜面檔案 (TJA格式) 的資料夾，即可在自訂歌單中遊玩。"],
      ko: [
